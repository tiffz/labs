...
[`src/encore/`](src/encore/AGENTS.md) · [`src/gesture/`](src/gesture/AGENTS.md) · [`src/lyrefly/`](src/lyrefly/AGENTS.md) · [`src/scrapboard/`](src/scrapboard/AGENTS.md) · [`src/stanza/`](src/stanza/AGENTS.md) · [`src/shared/`](src/shared/AGENTS.md) · [`src/words/`](src/words/AGENTS.md) · [`src/drums/`](src/drums/AGENTS.md) · [`src/piano/`](src/piano/AGENTS.md) · [`src/chords/`](src/chords/AGENTS.md) · [`src/cats/`](src/cats/AGENTS.md) · [`src/scales/`](src/scales/AGENTS.md) · [`src/sight/`](src/sight/AGENTS.md) · [`src/zinebox/`](src/zinebox/AGENTS.md) · [`src/muscle/`](src/muscle/AGENTS.md) · [`src/midi/`](src/midi/AGENTS.md)
...
| **New UI / layout / upload-sync UX**                   | [`docs/UX_AGENT_GUIDE.md`](docs/UX_AGENT_GUIDE.md), [`docs/RESPONSIVE_DESIGN.md`](docs/RESPONSIVE_DESIGN.md), app `DESIGN.md`, `STYLE_GUIDE.md` **(B)**; `.cursor/rules/ux-agent-guide.mdc`, `.cursor/rules/responsive-design.mdc`                                               | `labs-ux-journey`              |
| **Selection tiers (toggles, chips, popover interior)** | [`docs/SELECTION_VISUAL_HIERARCHY.md`](docs/SELECTION_VISUAL_HIERARCHY.md), `THEMING_DECISIONS.md` **(B)**; `.cursor/rules/selection-visual-hierarchy.mdc`                                                                                                                       | —                              |
| **Focus ring theming (keyboard a11y + CSS tokens)**    | [`docs/FOCUS_THEMING.md`](docs/FOCUS_THEMING.md), [`docs/A11Y_MENU_PATTERNS.md`](docs/A11Y_MENU_PATTERNS.md) **(B)**; `.cursor/rules/focus-theming.mdc`                                                                                                                          | —                              |
| **New UI control / form field**                        | Search `/ui/` + `src/ui/generatedSharedCatalog.ts`; [`SHARED_UI_CONVENTIONS.md`](src/shared/SHARED_UI_CONVENTIONS.md) (§ First-class vs portable); `.cursor/rules/shared-ui-first.mdc` **(B)** — check app README **Intentional diversions** before replacing app-local controls | —                              |
...
| Flaky Vitest / pre-commit timeouts                     | [`docs/FLAKY_TESTS.md`](docs/FLAKY_TESTS.md), [`.cursor/rules/flaky-tests.mdc`](.cursor/rules/flaky-tests.mdc) **(B)**                                                                                                                                                           | —                              |

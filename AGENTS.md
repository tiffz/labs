...
- **Scales learner copy** (`src/scales/COPY_STYLE.md`): user-facing prose in `src/scales/` (tiers, stages, tips, dialogs) should follow that voice guide (warm, concise, no em-dash essay tone).

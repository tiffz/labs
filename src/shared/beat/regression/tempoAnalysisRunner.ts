 ...
 *
 * Usage:
 *   npx tsx src/shared/beat/regression/tempoAnalysisRunner.ts public/.hidden/test-config.json
 *   npx tsx src/shared/beat/regression/tempoAnalysisRunner.ts public/.hidden/test-config.json --id wish-my-life-away
 */

import * as fs from 'fs';
import * as path from 'path';
import { analyzeBeat } from '../findTheBeatAnalyzer';
import { extractAudioBuffer, findMediaFile, isFFmpegAvailable } from './nodeAudio';

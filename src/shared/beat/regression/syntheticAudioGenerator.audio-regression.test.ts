...
} from '../../test/audioRegression';

const BASELINE_PATH = path.resolve(__dirname, 'baselines/synthetic-audio.hashes.json');
const REPORT_PATH = path.resolve(__dirname, 'reports/synthetic-audio.latest.json');

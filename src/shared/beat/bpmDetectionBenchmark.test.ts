 ...
 *   - Or directly: npm test -- --run src/shared/beat/bpmDetectionBenchmark.test.ts
 * 
 ...
 *   TEMPO_ALGORITHM=autocorrelation npm test -- --run src/shared/beat/bpmDetectionBenchmark.test.ts
 */
...
import {
  ...
  listTempoDetectors,
  type TempoDetector,
} from './regression/tempoDetectorInterface';

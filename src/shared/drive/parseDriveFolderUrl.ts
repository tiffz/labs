...
/**
 * Folder id from multiline paste / URL / raw id.
 * Folder URLs via {@link parseDriveFolderIdFromUrlOrId}, then single-line token via {@link parseDriveFileIdFromUrlOrId}.
 */

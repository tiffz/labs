...
export const TIERS: Tier[] = [
  {
    ...
    description:
      'Five-finger patterns in C, G, F, D, and A, each in one span. After quarter-note fluency, each key adds guided subdivision clicks, then beat-only fades: eighths, triplets, sixteenths.',
    exercises: [

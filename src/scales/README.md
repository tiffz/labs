...
**Google Drive backup:** Auto pull/push of practice progress when signed in (optional allowlist via `VITE_LABS_DRIVE_TESTER_HASHES`; empty allowlist = all signed-in users). See [`docs/LOCAL_FIRST_SYNC.md`](../../docs/LOCAL_FIRST_SYNC.md) and [ADR 0012](../../docs/adr/0012-scales-drive-sync-parity.md).

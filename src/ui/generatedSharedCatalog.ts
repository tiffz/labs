...
export const SHARED_CATALOG: ReadonlyArray<SharedCatalogEntry> = [
  ...
  },
  {
    ...
    "stability": "stable",
    "owner": "shared-core",
    "description": "Returns a usable access token for Drive + userinfo: prefers a fresh Encore-persisted token after userinfo validation; otherwise silent then interactive GIS refresh with minimal scopes.",
    "tags": [],
    "appsUsing": [],
    "exportType": "function",
    "demoId": null

...
export const ARTIST_STUDY_MANIFEST: ArtistStudyEntry[] = [
  ...
  // Torso — individual muscles (no regional buckets)
  { id: 'muscle_pectoralis_major', displayName: 'Pectoralis major', moduleId: 'torso', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Pecs & Breasts', colloquialNames: ['pecs'] },
  { id: 'muscle_rectus_abdominis', displayName: 'Rectus abdominis', moduleId: 'torso', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Abs', colloquialNames: ['abs'] },
  { id: 'muscle_external_oblique', displayName: 'External oblique', moduleId: 'torso', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Obliques', colloquialNames: ['obliques'] },
  { id: 'muscle_serratus_anterior', displayName: 'Serratus anterior', moduleId: 'torso', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Torso Drawing' },
  { id: 'muscle_latissimus_dorsi', displayName: 'Latissimus dorsi', moduleId: 'torso', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Upper Back Muscles', colloquialNames: ['lats'] },
  { id: 'muscle_erector_spinae', displayName: 'Erector spinae group', moduleId: 'torso', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Lower Back Muscles' },
  // Shoulder & neck
  ...
  { id: 'muscle_trapezius_upper', displayName: 'Upper trapezius', moduleId: 'shoulder_neck', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Neck Muscles', colloquialNames: ['traps'] },
  { id: 'muscle_sternocleidomastoid', displayName: 'Sternocleidomastoid', moduleId: 'shoulder_neck', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Neck Muscles', colloquialNames: ['SCM'] },
  ...
  { id: 'muscle_rhomboid_major', displayName: 'Rhomboid major', moduleId: 'shoulder_neck', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Upper Back Muscles' },
  ...
  { id: 'muscle_teres_major', displayName: 'Teres major', moduleId: 'shoulder_neck', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Shoulder Muscles' },
  ...
  // Arm — individual muscles (forearm is a region, not a muscle group)
  { id: 'muscle_biceps_brachii', displayName: 'Biceps brachii', moduleId: 'arm', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Arms', afsChapterTag: 'Arm and Hand in Motion' },
  { id: 'muscle_triceps_long_head', displayName: 'Triceps (long head)', moduleId: 'arm', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Arms' },
  { id: 'muscle_brachialis', displayName: 'Brachialis', moduleId: 'arm', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Arms' },
  { id: 'muscle_brachioradialis', displayName: 'Brachioradialis', moduleId: 'arm', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Arms' },
  { id: 'muscle_extensor_carpi_radialis', displayName: 'Extensor carpi radialis', moduleId: 'arm', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Arms' },
  { id: 'muscle_flexor_carpi_radialis', displayName: 'Flexor carpi radialis', moduleId: 'arm', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Arms' },
  // Hand
  ...
  { id: 'muscle_thenar_eminence', displayName: 'Thenar eminence', moduleId: 'hand', studyGroupPath: ['Thenar muscles'], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Hands' },
  { id: 'muscle_hypothenar_eminence', displayName: 'Hypothenar eminence', moduleId: 'hand', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Hands' },
  { id: 'muscle_flexor_pollicis_brevis', displayName: 'Flexor pollicis brevis', moduleId: 'hand', studyGroupPath: ['Thenar muscles'], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Hands' },
  { id: 'muscle_lumbricals_hand', displayName: 'Lumbricals', moduleId: 'hand', studyGroupPath: ['Intrinsic muscles of the hand'], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Hands' },
  { id: 'muscle_dorsal_interossei_hand', displayName: 'Dorsal interossei', moduleId: 'hand', studyGroupPath: ['Intrinsic muscles of the hand'], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Hands' },
  { id: 'muscle_flexor_digitorum_superficialis', displayName: 'Flexor digitorum superficialis', moduleId: 'hand', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Hands' },
  { id: 'muscle_extensor_digitorum', displayName: 'Extensor digitorum', moduleId: 'hand', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Hands' },
  // Leg
  ...
  { id: 'muscle_quadriceps_rectus_femoris', displayName: 'Rectus femoris', moduleId: 'leg', studyGroupPath: ['Quadriceps femoris'], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Legs', colloquialNames: ['quads'] },
  { id: 'muscle_vastus_lateralis', displayName: 'Vastus lateralis', moduleId: 'leg', studyGroupPath: ['Quadriceps femoris'], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Legs', colloquialNames: ['quads'] },
  { id: 'muscle_hamstrings_biceps_femoris', displayName: 'Biceps femoris', moduleId: 'leg', studyGroupPath: ['Hamstrings'], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Legs', colloquialNames: ['hamstrings'] },
  { id: 'muscle_gastrocnemius', displayName: 'Gastrocnemius', moduleId: 'leg', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Legs', colloquialNames: ['calf'] },
  { id: 'muscle_tibialis_anterior', displayName: 'Tibialis anterior', moduleId: 'leg', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Legs' },
  { id: 'muscle_gluteus_maximus', displayName: 'Gluteus maximus', moduleId: 'leg', studyGroupPath: ['Gluteal muscles'], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Legs', colloquialNames: ['glutes'] },
  { id: 'muscle_gluteus_medius', displayName: 'Gluteus medius', moduleId: 'leg', studyGroupPath: ['Gluteal muscles'], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Legs', colloquialNames: ['glutes'] },
  { id: 'muscle_gluteus_minimus', displayName: 'Gluteus minimus', moduleId: 'leg', studyGroupPath: ['Gluteal muscles'], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Legs' },
  { id: 'muscle_tensor_fasciae_latae', displayName: 'Tensor fasciae latae', moduleId: 'leg', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Legs', colloquialNames: ['TFL'] },
  { id: 'muscle_adductor_longus', displayName: 'Adductor longus', moduleId: 'leg', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Legs', colloquialNames: ['adductors'] },
  // Foot
  ...
  { id: 'muscle_abductor_hallucis', displayName: 'Abductor hallucis', moduleId: 'foot', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Feet' },
  { id: 'muscle_flexor_digitorum_brevis', displayName: 'Flexor digitorum brevis', moduleId: 'foot', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Feet' },
  { id: 'muscle_lumbricals_foot', displayName: 'Lumbricals', moduleId: 'foot', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Feet' },
  { id: 'muscle_extensor_digitorum_brevis', displayName: 'Extensor digitorum brevis', moduleId: 'foot', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Feet' },
  { id: 'muscle_peroneus_longus', displayName: 'Peroneus longus', moduleId: 'foot', studyGroupPath: [], defaultVisible: true, quizEligible: true, prokoLessonRef: 'Feet' },
];

...
const App: React.FC = () => {
  ...
  const sectionsColumnProps = useWordsSectionsColumnProps(
    {
      ...
      activeSectionLoopId,
      isPlaying,
      sectionTemplatePreviewById: songModel.sectionTemplatePreviewById,
      templatePresets: songModel.templatePresets,
      ...
      timeSignature,
      metronomeEnabled,
      findTemplatePresetByNotation: songModel.findPresetByNotation,
    },
    {
  ...
  const playbackRailProps = useWordsPlaybackRailProps({
    ...
    setBackingBeatNotation,
    templatePresets: songModel.templatePresets,
    backingSelectedTemplatePreset: songModel.backingSelectedTemplatePreset,
    randomizeBackingTemplate,
    backingPatternRhythm: songModel.backingPatternRhythm,
    backingTemplateVariations: songModel.backingTemplateVariations,
    backingActiveVariationIndex: songModel.backingActiveVariationIndex,
    autoFollowPlayback,

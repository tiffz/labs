...
import type { PianoScore, MicrophoneDevice, PracticeRun, Key } from './types';
...
import type { PianoState, Action, ActiveMode } from './storeTypes';
import { initialState } from './storeTypes';
// eslint-disable-next-line react-refresh/only-export-components -- re-exported from storeTypes alongside Provider for backward-compat
export { initialState } from './storeTypes';
export type { ActiveMode, ScoreSection, PianoState, Action } from './storeTypes';

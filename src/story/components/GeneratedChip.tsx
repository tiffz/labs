...
export const GeneratedChip: React.FC<GeneratedChipProps> = ({ 
  ...
  const buttonClass = inline
    ? "flex items-center justify-center w-4 h-4 rounded bg-gradient-to-br from-orange-50/90 to-pink-50/80 text-orange-500 hover:text-orange-600 hover:from-orange-100/90 hover:to-pink-100/80 transition-all duration-150 focus:outline-none focus:ring-1 focus:ring-orange-400 shadow-sm"
    : compact
    ? "flex items-center justify-center w-4 h-4 rounded bg-gradient-to-br from-orange-50/90 to-pink-50/80 text-orange-500 hover:text-orange-600 hover:from-orange-100/90 hover:to-pink-100/80 transition-all duration-150 focus:outline-none focus:ring-1 focus:ring-orange-400 shadow-sm"
    : "flex items-center justify-center w-5 h-5 rounded bg-gradient-to-br from-orange-50/90 to-pink-50/80 text-orange-500 hover:text-orange-600 hover:from-orange-100/90 hover:to-pink-100/80 transition-all duration-150 focus:outline-none focus:ring-1 focus:ring-orange-400 shadow-sm";

---
description: Ship to prod by default — automated gates decide, human review is reserved for changes that are both high-blast-radius and hard for an agent to verify
alwaysApply: true
---

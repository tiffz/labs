---
description: Retrieve runtime debug data from a local dev session through a /__debug_* dev-server pipe you read yourself — never ask the user to forward artifacts
globs:
  - vite.config.ts
  - src/shared/debug/**

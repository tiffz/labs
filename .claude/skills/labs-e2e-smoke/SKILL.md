...
<!-- AUTO-GENERATED from .cursor/skills/labs-e2e-smoke/SKILL.md — do not edit directly. Edit the source and run `npm run generate:claude-guidance`. -->
...
- Shell, provider, or `e2e/` changes → `npm run presubmit:push` before push (see [`.cursor/rules/pre-commit-checks.md`](../../rules/pre-commit-checks.md)).

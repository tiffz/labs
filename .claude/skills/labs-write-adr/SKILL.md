...
<!-- AUTO-GENERATED from .cursor/skills/labs-write-adr/SKILL.md — do not edit directly. Edit the source and run `npm run generate:claude-guidance`. -->
...
Matching paths auto-load [`.cursor/rules/architecture-decisions.md`](../../rules/architecture-decisions.md).

...
<!-- AUTO-GENERATED from .agents/rules/ux-restraint.md — do not edit directly. Edit the source and run `npm run generate:agent-guidance`. -->

> Subtraction-first UX — remove any element the design works without; no redundant help text, duplicate controls, or over-carding

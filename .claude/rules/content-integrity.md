...
<!-- AUTO-GENERATED from .agents/rules/content-integrity.md — do not edit directly. Edit the source and run `npm run generate:agent-guidance`. -->

> Generative / curriculum content needs an exhaustive validity test and expert review — the accuracy attribute has no compiler

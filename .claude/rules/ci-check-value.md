<!-- AUTO-GENERATED from .agents/rules/ci-check-value.md — do not edit directly. Edit the source and run `npm run generate:agent-guidance`. -->

> Before adding, keeping, or deleting a CI check — decide its placement deliberately, and give every non-blocking check a way to write itself down

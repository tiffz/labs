...
<!-- AUTO-GENERATED from .agents/rules/material-icon-sizing.md — do not edit directly. Edit the source and run `npm run generate:agent-guidance`. -->

> Material icon sizing — glyph must clear its chrome, and reserve its box before the font loads

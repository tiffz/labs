...
| —          | 5     | Remaining majors (@mui/material 9, TipTap 3, pdfjs 5, three, name-generator).                                                                                                                                                                                                                              | Deferred.                                                                                                                                                                                                                                                                                                                                                                  |
...
- Still open: `@mui/material` 7 → 9, TipTap 2 → 3, `pdfjs-dist` 4 → 5, `three` / name-generator majors; react-hooks Compiler rule ratchet

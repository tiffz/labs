...
| —          | 6     | Remaining app majors (TipTap 3, pdfjs 5, three, name-generator).                                                                                                                                                                                                                                           | Deferred.                                                                                                                                                                                                                                                                                                                                                                  |
...
- Still open: TipTap 2 → 3, `pdfjs-dist` 4 → 5, `three` / name-generator majors; react-hooks Compiler rule ratchet

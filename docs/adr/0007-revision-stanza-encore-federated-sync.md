...
| Dual-read / dual-write migration           | **Stanza side done** — pull merges + push rewrites the overlay in [`useStanzaDriveBackup.tsx`](../../src/stanza/hooks/useStanzaDriveBackup.tsx); Encore-side read/linking remains — see [`stanza-encore-overlay-migration.md`](../design-explorations/stanza-encore-overlay-migration.md) |

...
| **Nested agent context (monorepo apps)**                        | `src/<app>/AGENTS.md` (+ app `README.md`)                                            | Encore, Stanza, Gesture, Zine Box, shared, Words, Drums, Piano, Chords, Cats, Scales, Sight: see root `AGENTS.md` § Start Here. |

...
| **Nested agent context (monorepo apps)**                        | `src/<app>/AGENTS.md` (+ app `README.md`)                                            | Encore, Stanza, shared, Words, Drums, Piano, Chords, Cats, Scales: see root `AGENTS.md` § Start Here.        |
